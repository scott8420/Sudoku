...
ShortcutsDialog::ShortcutsDialog() {
    set_name("shortcuts_dialog");
    registry::add("shortcuts_dialog", this);

    set_title("Keyboard Shortcuts");
    set_modal(false);
    set_resizable(true);
    set_default_size(460, 620);
    ...
    // correctly. This is the same list Application wires accelerators from.
    ...
    m_btn_close.set_name("shortcuts_close");
